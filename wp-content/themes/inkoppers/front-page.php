...
<main class="main-header">
    <div class="waypoint-animation">
        <div class="header__background-image position-relative">
            ...
            <img
                ...
                alt=""
                class="header__image-overlay w-100 d-none d-lg-block rise-animation"
            />
            <div class="container-fluid header-text d-none d-lg-flex rise-animation">
                <div class="col-lg-4">
            ...
            <div class="row">
                <div tabindex="-1" class="col-lg-6 offset-lg-3">
                    <?php if ($textDarkBackground): ?>
                        <p class="bgc-dark slide-right-animation">
    ...
    <div class="waypoint-animation">
        ...
        >
            <div class="row">
                <div class="col-lg-5 offset-lg-1 slide-right-animation">
                ...
                <div class="col-lg-5 d-flex align-items-end mt-3 mt-lg-0 slide-left-animation">
    ...
    <div class="waypoint-animation">
        ...
        >
            <div class="row no-mx-mobile">
                ...
                <div class="col d-xl-none first-mobile-center-slider-div px-0 rise-animation">
                ...
                <!-- desktop -->
                <div class="col-xl-10 offset-xl-1 team-container d-none d-xl-block rise-animation">
                    <div class="row">
                        <div class="col-xl-3">
                            <img 
                                src="<?php echo $teamImage1['sizes']['large']; ?>"
    ...
    <div class="waypoint-animation">
        ...
        >
            ...
            <!-- Desktop -->
            <div class="container-fluid d-none d-lg-block rise-animation">
                <div class="row mx-0">
