...
<footer class="bgc-gray-5 <?php if ( is_page( 1 ) ): ?><?php echo "bgc-dark"; ?><?php endif; ?> pt-lg-5">
    <!-- Mobile -->
    <div class="container-fluid top-footer-mobile d-lg-none rise-animation">
        <div class="row">
            <div class="col-3">
    ...
    <div class="waypoint-animation">
        <div class="container-fluid top-footer-desktop py-lg-5 d-none d-lg-block rise-animation">
    ...
    <div class="container-fluid bottom-footer-mobile d-lg-none rise-animation">
    ...
    <div
        class="container-fluid bottom-footer-desktop py-lg-5 d-none d-lg-block rise-animation"
    >
        <div class="row">
